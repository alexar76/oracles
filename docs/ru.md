...
> **Честно о криптографии:** уровень research/prototype, не hardened production. Chronos: без внешнего аудита; hybrid PQC: опционально, слабая спека. → **[crypto-maturity.ru.md](crypto-maturity.ru.md)** · [EN](crypto-maturity.en.md)
