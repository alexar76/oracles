...
<!-- aicom-readme-badges -->
<p align="center">
  <a href="https://github.com/alexar76/oracles/actions/workflows/ci.yml"><img src="https://raw.githubusercontent.com/alexar76/oracles/refs/heads/main/docs/badges/ci.svg" alt="CI" /></a>
  <img src="https://raw.githubusercontent.com/alexar76/oracles/refs/heads/main/docs/badges/tests.svg" alt="153 tests passing" />
  <img src="https://raw.githubusercontent.com/alexar76/oracles/refs/heads/main/docs/badges/aimarket.svg" alt="AIMarket v2" />
  <img src="https://raw.githubusercontent.com/alexar76/oracles/refs/heads/main/docs/badges/signing.svg" alt="Ed25519 + ML-DSA signing" />
  <a href="https://raw.githubusercontent.com/alexar76/oracles/refs/heads/main/docs/badges/coverage.svg"><img src="https://raw.githubusercontent.com/alexar76/oracles/refs/heads/main/docs/badges/coverage.svg" alt="Test coverage" /></a>
  <a href="https://github.com/alexar76/oracles/blob/main/LICENSE"><img src="https://raw.githubusercontent.com/alexar76/oracles/refs/heads/main/docs/badges/license.svg" alt="License: MIT" /></a>
</p>
<!-- /aicom-readme-badges -->

> 🌐 **English** · [Русский](docs/ru.md) · [Español](docs/es.md) · [Français](docs/README.fr.md) · [中文](docs/README.zh.md) · [Glossary](https://github.com/alexar76/aicom/blob/main/docs/localization-glossary.md)




> **Cryptographic maturity (honest):** Seventeen oracles in ~two months of engineering → **strong research / prototype**, not a fully **hardened production** crypto service. Chronos VDF parameters live in source but there is **no external audit or formal verification** yet; hybrid Ed25519 + ML-DSA is **optional and off by default** (Hub verifies Ed25519 only). Read before mainnet-scale TVL: **[docs/crypto-maturity.en.md](docs/crypto-maturity.en.md)** · [RU](docs/crypto-maturity.ru.md) · Factory [KI-6](https://github.com/alexar76/aicom/blob/main/docs/known-issues.md#ki-6--oracle-family-cryptographic-maturity-not-production-hardened).
...
├── core/docs/SIGNING.md       # hybrid signing implementation note (not normative spec)
├── docs/crypto-maturity.{en,ru}.md  # honest crypto maturity statement
...
- **Live:** https://oracles.modelmarket.dev/
- **Docs:** https://github.com/alexar76/oracles/blob/main/docs/en.md

## Related repos

| Repo | Role |
|------|------|
| [aicom](https://github.com/alexar76/aicom) | AI-Factory — ships oracle integrations |
| [aimarket-hub](https://github.com/alexar76/aimarket-hub) | Hub — signed manifests, invoke, pricing |
| [lottery](https://github.com/alexar76/lottery) | Canonical oracle consumer (Platon + Chronos + LUMEN) |
| [aimarket-protocol](https://github.com/alexar76/aimarket-protocol) | Normative v2 spec |
| [alien-monitor](https://github.com/alexar76/alien-monitor) | Live oracle nodes on the ecosystem graph |
