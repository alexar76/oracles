    ...
    capabilities=[
        Capability(
            ...
            description=(
                ...
                "far from optimal the tour can possibly be. When coincident points make "
                "the lower bound 0 it certifies nothing, so gap is null (unknown) unless "
                "the tour length is also 0 (all points coincide -> provably optimal)."
            ),
            handler=_optimize,
            input_schema={
                "type": "object",
            ...
            output_schema={
                ...
                "properties": {
                    ...
                    "gap": {
                        "type": ["number", "null"],
                        "description": (
                            "Optimality gap (length - lower_bound) / lower_bound, or "
                            "null when the lower bound is 0 and thus certifies nothing."
                        ),
                    },
                    "n": {"type": "integer"},
