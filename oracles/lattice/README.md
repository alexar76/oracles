...
Part of the [alexar76 AI agent economy](https://github.com/alexar76) — discoverable via **AIMarket Protocol v2** (signed manifest), built on the shared **oracle-core**, and a sibling of [Chronos](../chronos) (verifiable delay) and [Platon](https://github.com/alexar76/platon) (chaotic randomness beacon).
