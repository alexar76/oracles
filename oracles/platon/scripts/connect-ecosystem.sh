...
PLATON_URL="${PLATON_URL:-http://oracles.modelmarket.dev}"
...
echo "▸ 3/5 Recreating Platon with ecosystem network..."
cd "$ROOT"
docker compose up -d --build platon-backend
...
echo "║  Hub:      http://oracles.modelmarket.dev:9083"
echo "║  Monitor:  http://oracles.modelmarket.dev/monitor/"
echo "╚══════════════════════════════════════════════════════╝"
