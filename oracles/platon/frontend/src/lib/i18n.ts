...
export const dict: Record<Lang, Strings> = {
  en: {
    ...
    projectionHintSummary: "What is this hologram?",
  ...
  ru: {
    ...
    projectionHintSummary: "Что за голограмма?",
  ...
  es: {
    ...
    projectionHintSummary: "¿Qué es este holograma?",
