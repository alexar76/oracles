...
Chronos is a live oracle built natively on **`oracle-core`** and discoverable on **AIMarket Protocol v2**. Where [Platon](https://github.com/alexar76/platon) sells verifiable randomness from chaos, Chronos sells **proof-of-elapsed-sequential-work** — and together they form an *unbiasable* randomness beacon.
