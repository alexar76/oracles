...
With `c = 4.685` (the standard Holland–Welsch tuning constant for the consistent,
×1.4826-scaled MAD) the estimator is ~95% efficient at a clean Gaussian yet immune
to gross outliers.
