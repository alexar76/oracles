...
Con `c = 4.685` (la constante de ajuste estándar de Holland–Welsch para la MAD
consistente, escalada por ×1.4826) el estimador alcanza ~95% de eficiencia en una
gaussiana limpia y a la vez es inmune a valores atípicos extremos.
