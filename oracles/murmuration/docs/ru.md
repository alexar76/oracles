...
При `c = 4.685` (стандартная константа настройки Холланда–Уэлша для согласованной,
масштабированной на ×1.4826 MAD) оценщик даёт ~95% эффективности на чистом гауссиане
и при этом невосприимчив к грубым выбросам.
